  ...
  <div className="row">
    <div className="col-lg-5">
      <div className="dexon-section-title white padding-lg">
        <h4>Services</h4>
        <h1 className="sections">GSM Services</h1>
      </div>
    </div>
    <div className="col-lg-7">
      <div className="dexon-desc">
        <p>
          SSConsultant offers comprehensive GSM (Garment Supply Management) services designed to optimize the production workflow and enhance operational efficiency. Our system includes essential modules like Fabric Management, Bill of Material, Cutting Management, Fabric Roll Management, and Fabric Transaction to ensure seamless integration across the garment supply chain.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="row service-bg">
    <div className="col-lg-5">
      <div className="serivce-thumb">
        <img src="assets/images/resource/gsm.jpg" alt="GSM Services" />
      </div>
    </div>
    <div className="col-lg-7">
      <div className="row">
        <div className="col-lg-12">
          <div className="single-service-box2">
            <div className="service-icon">
              <img src="assets/images/resource/icongif7.gif" alt="Fabric Management Icon" />
            </div>
            <div className="service-content">
              <h2 className="service-title">Fabric Management</h2>
              <p className="service-desc">
                Efficiently manage fabric inventory, allocation, and tracking to meet production needs.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            <div className="service-icon">
              <img src="assets/images/resource/icongif19.gif" alt="Bill of Material Icon" />
            </div>
            <div className="service-content">
              <h2 className="service-title">Bill of Material</h2>
              <p className="service-desc">
                Create detailed BOMs for accurate planning and resource utilization.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            <div className="service-icon">
              <img src="assets/images/resource/icongif3.gif" alt="Cutting Management Icon" />
            </div>
            <div className="service-content">
              <h2 className="service-title">Cutting Management</h2>
              <p className="service-desc">
                Streamline the cutting process to ensure precision and minimize fabric wastage.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            <div className="service-icon">
              <img src="assets/images/resource/icongif20.gif" alt="Fabric Roll Management Icon" />
            </div>
            <div className="service-content">
              <h2 className="service-title">Fabric Roll Management</h2>
              <p className="service-desc">
                Organize and track fabric rolls to ensure smooth handling and availability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-12">
          <div className="single-service-box2">
            <div className="service-icon">
              <img src="assets/images/resource/icongif4.gif" alt="Fabric Transaction Icon" />
            </div>
            <div className="service-content">
              <h2 className="service-title">Fabric Transaction</h2>
              <p className="service-desc">
                Maintain a record of fabric transactions for improved traceability and accountability.
              </p>
            </div>
          </div>
        </div>
