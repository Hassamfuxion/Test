    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          <h4>Services</h4>
          <h1 className="sections">Vehicle Management</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant offers comprehensive Vehicle Management services to optimize vehicle operations and ensure seamless transportation processes. Our system includes key modules such as Vehicle Tracking and Maintenance Management to provide efficient and reliable solutions tailored to your business needs.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/vehicle.jpg" alt="Vehicle Management Services" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif5.gif" alt="Vehicle Tracking Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Vehicle Tracking</h2>
                <p className="service-desc">
                  Monitor and manage vehicle locations for efficient fleet management.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif24.gif" alt="Maintenance Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Maintenance Management</h2>
                <p className="service-desc">
                  Ensure vehicles are well-maintained to reduce downtime and improve performance.
                </p>
              </div>
            </div>
          </div>
