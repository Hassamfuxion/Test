...
import { AiFillFileAdd, AiFillCalculator, AiOutlineImport, AiFillClockCircle } from 'react-icons/ai';
import { FaMoneyCheckAlt, FaDatabase } from 'react-icons/fa';
import { BeatLoader, ClipLoader, RotatingLines } from 'react-spinners';
    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          ...
          <h1 className="sections">Finance Management</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant offers a comprehensive Finance Management solution designed to streamline your organization's financial operations. Our system covers essential modules like Accounts Payable, Accounts Receivable, Fixed Assets, General Ledger, Import, and Time Billing, ensuring efficient financial management for businesses of all sizes.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/finance.jpg" alt="" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif.gif" alt="" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Accounts Payable</h2>
                <p className="service-desc">
                  Efficient management of vendor payments and tracking financial obligations.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif2.gif" alt="" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Accounts Receivable</h2>
                <p className="service-desc">
                  Streamlined process for managing customer invoices and payments.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif3.gif" alt="" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Fixed Assets</h2>
                <p className="service-desc">
                  Comprehensive tracking of fixed assets, ensuring optimal asset management.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif4.gif" alt="" />
              </div>
              <div className="service-content">
                <h2 className="service-title">General Ledger</h2>
                <p className="service-desc">
                  Accurate financial recording and management across different business functions.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif5.gif" alt="" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Import</h2>
                <p className="service-desc">
                  Streamlined import processes ensuring efficient data handling and processing.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif6.gif" alt="" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Time Billing</h2>
                <p className="service-desc">
                  Accurate tracking and management of billable hours and project costs.
                </p>
              </div>
            </div>
          </div>
