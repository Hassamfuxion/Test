    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          <h4>Services</h4>
          <h1 className="sections">Thread Management</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant offers specialized Thread Management services to optimize thread utilization and ensure seamless production processes. Our system includes key modules such as Thread Management and Thread Setup to provide precise and efficient solutions tailored to your business needs.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/thread.jpg" alt="Thread Management Services" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif5.gif" alt="Thread Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Thread Management</h2>
                <p className="service-desc">
                  Effectively manage thread inventory and allocation to meet production demands.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif20.gif" alt="Thread Setup Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Thread Setup</h2>
                <p className="service-desc">
                  Configure thread settings to ensure accurate planning and seamless integration.
                </p>
              </div>
            </div>
          </div>
