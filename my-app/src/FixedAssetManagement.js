    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          <h4>Services</h4>
          <h1 className="sections">Fixed Assets Management</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant provides robust Fixed Assets Management services to streamline asset tracking and maintenance. Our solutions include advanced tools for Asset Tracking and Maintenance Scheduling, ensuring your business assets remain efficient, secure, and operational.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/fixed-assets.jpg" alt="Fixed Assets Management Services" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif5.gif" alt="Asset Tracking Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Asset Tracking</h2>
                <p className="service-desc">
                  Monitor and manage your business assets efficiently to maximize utilization.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif24.gif" alt="Maintenance Scheduling Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Maintenance Scheduling</h2>
                <p className="service-desc">
                  Plan and execute maintenance schedules to prolong asset lifespan and reduce downtime.
                </p>
              </div>
            </div>
          </div>
