...
import ClientTestimonial from "./ClientTestimonial.js";

import SplineComponent1 from "./spline2.js";

import About from './About'; // About page component
import Service from './service.js'; // Service page component
...
<div>
  ...
  {/*==================================================*/}
  {/* Start dexon Hero Section  */}
  {/*==================================================*/}
  
  {/* <div
    className="hero-section hero2 d-flex align-items-center"
    style={{
      ...
      <div className="row align-items-center hero-bg">
        <div className="col-lg-6">
          <div className="hero-content2">
            ...
            <h1> Your Partner </h1>
            <h1>
              <span style={{ color: "#00c2ff" }}>SSCONSULTANT</span>
            </h1>
            <p>
            ...
            <div className="hero-button">
              ...
              >
                Get Started <i className="bi bi-arrow-right-short" />
              </a>
            </div>
          </div>
        </div>
      ...
      <div className="col-lg-7">
        <div className="row">
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icon30.gif" alt="" />
              </div>
              <div className="service-content">
...
<div className="col-lg-4 col-md-6">
        ...
        <div className="row about-bg">
          ...
          <div className="col-lg-6">
            ...
            >
              ...
              <div
                className="heading"
                style={{ fontSize: "1.5rem", marginTop: 15 }}
              >
  ...
  <div className="row about-bg">
    <div className="col-lg-6">
      <div className="dexon-section-title white">
        <h1> THE BEST ERP AGENCY </h1>
        <h1> IN THE WORLD </h1>
        <p style={{ color: 'white', fontSize: '14px' }}> 
          Our ERP solutions streamline your business processes, enhance data security, and provide real-time insights for informed decision-making.
        </p>
      </div>
      <div className="about-people">
      <a href="./About"> <button className="btn">SEE MORE</button></a>
      </div>
    </div>
  ...
  >
    <div className="container">
      <div className="row" >
        <div className="col-lg-12" >
          <div className="dexon-section-title white text-center padding-lg">
            <h1> Already We’ve Finished Those </h1>
            <h1> ERP Project </h1>
  ...
  <div className="col-lg-8">
    <div className="single-project-box">
      <div className="project-thumb">
        <img src="assets/images/resource/pr1.jpg" alt="ERP Software Implementation" />
        <div className="project-content">
          <h5>Project</h5>
          <h2>ERP Software Implementation</h2>
          <a href="./service">
            <i className="bi bi-arrow-right-short" />
          </a>
        </div>
  ...
  <div className="col-lg-4 col-md-6">
    <div className="single-project-box">
      <div className="project-thumb">
        <img src="assets/images/resource/pr2.jpg" alt="Supply Chain Management ERP" />
        <div className="project-content">
          <h5>Project</h5>
          <h2>Supply Chain Management ERP</h2>
          <a href="./service">
            <i className="bi bi-arrow-right-short" />
          </a>
        </div>
  ...
  <div className="col-lg-4 col-md-6">
    <div className="single-project-box">
      <div className="project-thumb">
        <img src="assets/images/resource/pr3.jpg" alt="Financial Management ERP" />
        <div className="project-content">
          <h5>Project</h5>
          <h2>Financial Management ERP</h2>
          <a href="./service">
            <i className="bi bi-arrow-right-short" />
          </a>
        </div>
  ...
  <div className="col-lg-4 col-md-6">
    <div className="single-project-box">
      <div className="project-thumb">
        <img src="assets/images/resource/pr4.jpg" alt="Human Resources ERP" />
        <div className="project-content">
          <h5>Project</h5>
          <h2>Human Resources ERP</h2>
          <a href="./service">
            <i className="bi bi-arrow-right-short" />
          </a>
        </div>
  ...
  <div className="col-lg-4 col-md-6">
    <div className="single-project-box style-two">
      <div className="project-thumb">
        <img src="assets/images/resource/pr5.png" alt="All ERP Solutions" />
        <div className="project-button">
      
          <div className="dexon-button2 text-center">
            <a href="./service" >
              All ERP Solutions <i className="bi-arrow-right-short" />
            </a>
          </div>
        </div>
      </div>
  ...
  {/*==================================================*/}
  {/* End dexon Project Section  */}
  {/*==================================================*/}
  {/*==================================================*/}
  {/* Start Dexon Testimonial Section  */}
  {/*==================================================*/}
  ...
  <div className="App1">
    ...
    {/* Include the Testimonial component */}
    <ClientTestimonial />
  </div>
