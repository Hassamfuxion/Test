    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          <h4>Services</h4>
          <h1 className="sections">Shipment Services</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant offers reliable Shipment services to ensure efficient handling of logistics and transportation. Our system includes essential modules such as Booking Management, Shipment Container Management, and Shipment Setup to provide seamless shipping solutions for your business.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/shipment.jpg" alt="Shipment Services" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif5.gif" alt="Booking Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Booking Management</h2>
                <p className="service-desc">
                  Manage and organize shipment bookings to ensure timely and efficient transportation.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif23.gif" alt="Shipment Container Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Shipment Container Management</h2>
                <p className="service-desc">
                  Track and manage shipment containers for secure and organized logistics.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif22.gif" alt="Shipment Setup Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Shipment Setup</h2>
                <p className="service-desc">
                  Configure and customize shipment setups to meet specific business needs.
                </p>
              </div>
            </div>
          </div>
