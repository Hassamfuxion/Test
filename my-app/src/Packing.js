    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          <h4>Services</h4>
          <h1 className="sections">Packing Services</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant offers advanced Packing services to streamline packaging processes and ensure accuracy in production. Our system includes key modules such as EPC Management, Packing List Management, Order Size Management, and Barcode Management to deliver efficient and reliable solutions for your business.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/packing.jpg" alt="Packing Services" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif5.gif" alt="EPC Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">EPC Management</h2>
                <p className="service-desc">
                  Efficiently manage Export Packing Credits (EPC) to optimize cash flow and packaging resources.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif7.gif" alt="Packing List Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Packing List Management</h2>
                <p className="service-desc">
                  Streamline the creation and tracking of detailed packing lists for seamless logistics.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif22.gif" alt="Order Size Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Order Size Management</h2>
                <p className="service-desc">
                  Manage order sizes efficiently to ensure accurate packaging and order fulfillment.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif21.gif" alt="Barcode Management Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Barcode Management</h2>
                <p className="service-desc">
                  Generate and manage barcodes for efficient tracking and accurate identification.
                </p>
              </div>
            </div>
          </div>
