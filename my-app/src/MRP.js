    ...
    <div className="row">
      <div className="col-lg-5">
        <div className="dexon-section-title white padding-lg">
          <h4>Services</h4>
          <h1 className="sections">MRP Services</h1>
        </div>
      </div>
      <div className="col-lg-7">
        <div className="dexon-desc">
          <p>
            SSConsultant offers robust Material Requirements Planning (MRP) services to optimize resource allocation and streamline manufacturing processes. Our system includes essential modules like Inventory, Merchandising, MRP Setup, and Purchase, ensuring seamless integration and efficiency for your operations.
          </p>
        </div>
      </div>
    </div>
    ...
    <div className="row service-bg">
      <div className="col-lg-5">
        <div className="serivce-thumb">
          <img src="assets/images/resource/mrp.jpg" alt="MRP Services" />
        </div>
      </div>
      <div className="col-lg-7">
        <div className="row">
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif2.gif" alt="Inventory Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Inventory</h2>
                <p className="service-desc">
                  Efficient tracking and management of stock levels to meet production demands.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif2.gif" alt="Merchandising Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Merchandising</h2>
                <p className="service-desc">
                  Streamlined merchandising processes to ensure product availability and quality.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif3.gif" alt="MRP Setup Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">MRP Setup</h2>
                <p className="service-desc">
                  Comprehensive setup to ensure accurate planning and scheduling of resources.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-12">
            <div className="single-service-box2">
              <div className="service-icon">
                <img src="assets/images/resource/icongif4.gif" alt="Purchase Icon" />
              </div>
              <div className="service-content">
                <h2 className="service-title">Purchase</h2>
                <p className="service-desc">
                  Efficient management of procurement processes to ensure timely availability of materials.
                </p>
              </div>
            </div>
          </div>
